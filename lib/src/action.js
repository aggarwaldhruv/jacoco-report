        ...
        try {
            ...
            switch (event) {
                ...
                case 'push':
                    ...
                    prNumber = (_d = github.context.payload) === null || _d === void 0 ? void 0 : _d.number;
                    break;
                default:
            ...
            core.setOutput('coverage-overall', parseFloat(((_e = project.overall.percentage) !== null && _e !== void 0 ? _e : 0).toFixed(2)));
